...
```shell
# 社区版
docker pull dbsyncer.cn/images/xhtb-dbs/dbsyncer:latest
docker pull dbsyncer.cn/images/xhtb-dbs/dbsyncer:2.1.2
# 专业版
...
docker run -d \
  ...
  --log-opt max-file=7 \
  dbsyncer.cn/images/xhtb-dbs/dbsyncer:latest
