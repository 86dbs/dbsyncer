CREATE TABLE `dbsyncer_meta` (
  ...
  `TASK_ID` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '任务ID/任务明细ID',
  ...
  `SNAPSHOT` mediumtext CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '快照信息',
  PRIMARY KEY (`ID`) USING BTREE,
  INDEX `IDX_TASK_UPDATE_TIME_FAIL`(`TASK_ID`,`FAIL`,`UPDATE_TIME`) USING BTREE,
  INDEX `IDX_TASK_DETAIL_STATE`(`IS_TASK_DETAIL`, `STATE`) USING BTREE
