CREATE TABLE `dbsyncer_task_detail` (
    ...
    `SOURCE_TABLE_NAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '数据源表名称',
    `TARGET_TABLE_NAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '目标源表名称',
