CREATE TABLE `dbsyncer_task_detail` (
  ...
  `TABLE_GROUP_ID` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '关联表映射ID',
  `TYPE` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '任务类型, 事件insert/update/delete/ddl; 校验/迁移)',
