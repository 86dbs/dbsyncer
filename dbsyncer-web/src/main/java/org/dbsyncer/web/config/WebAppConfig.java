...
public class WebAppConfig extends WebSecurityConfigurerAdapter implements AuthenticationProvider, HttpSessionListener {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable().authorizeRequests().antMatchers("/css/**", "/js/**", "/img/**", "/plugins/**", "/index/version.json", "/openapi/**", "/cluster/ping", "/cluster/assignments", "/cluster/metrics", "/cluster/internal/**", "/sso/consume").permitAll().anyRequest().authenticated().and()
