...
echo %SERVER_OPTS%
java %SERVER_OPTS% -Dfile.encoding=GBK -Djava.ext.dirs=%JAVA_HOME%\jre\lib\ext;./plugins;./lib -Dspring.config.location=%cd%\conf\application.properties org.dbsyncer.web.Application