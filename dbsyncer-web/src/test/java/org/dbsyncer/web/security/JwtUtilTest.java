...
public class JwtUtilTest {
    ...
    public void testRefreshToken() throws InterruptedException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        Assert.assertTrue("新Token的过期时间应晚于原Token", newTokenInfo.getExp() > originalTokenInfo.getExp());

        logger.info("Token刷新成功，原Token过期时间: {}, 新Token过期时间: {}", originalTokenInfo.getExp(), newTokenInfo.getExp());
    }
