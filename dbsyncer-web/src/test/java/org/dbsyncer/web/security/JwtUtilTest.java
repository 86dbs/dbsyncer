...
public class JwtUtilTest {
    ...
    public void testGenerateToken() {
        ...
        String token = JwtUtil.generateToken(TEST_APP_ID, TEST_SECRET);
        Assert.assertNotNull("Token不应为空", token);
        Assert.assertTrue("Token应包含两个点", token.split("\\.").length == 3);
    ...
    public void testVerifyToken() {
        ...
        Assert.assertEquals("AppId应匹配", TEST_APP_ID, tokenInfo.getAppId());
    ...
    public void testRefreshToken() throws InterruptedException {
        ...
        String originalToken = JwtUtil.generateToken(TEST_APP_ID, TEST_SECRET);
        ...
        Assert.assertEquals("AppId应匹配", TEST_APP_ID, newTokenInfo.getAppId());
    ...
    @Test
    public void testTokenWithDifferentSecrets() {
        ...
        String token1 = JwtUtil.generateToken(TEST_APP_ID, secret1);
        String token2 = JwtUtil.generateToken(TEST_APP_ID, secret2);
