...
public class MySQLToSQLServerDDLSyncIntegrationTest extends BaseDDLIntegrationTest {
    ...
    // ==================== 辅助验证方法 ====================
    // 注意：所有验证方法（verifyFieldType, verifyFieldComment, verifyFieldNullable, 
    // verifyTableExists, verifyTableFieldCount, verifyTablePrimaryKeys）已移至基类 BaseDDLIntegrationTest
